port module Page.Participate exposing (init, update, view)
...
import Page.Participate.Lamp as Lamp
import Page.Participate.Message exposing (Msg(..))
import Page.Participate.Model exposing (Event, Model(..))
